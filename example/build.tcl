...
# Project creation
create_project zybo_z7_video_proc . -part xc7z020clg400-1
...
# Add CCI Master
create_bd_cell -type ip -vlnv hellgate202:user:cci_master:1.0 cci_master_0
set_property -dict [list CONFIG.CLK_FREQ {100000000}] [get_bd_cells cci_master_0]

# Add JTAG-AXI Controller
create_bd_cell -type ip -vlnv xilinx.com:ip:jtag_axi:1.2 jtag_axi_0
set_property -dict [list CONFIG.PROTOCOL {2}] [get_bd_cells jtag_axi_0]

# Add AXI4-Interconnect to connect JTAG controller and CCI-Master
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins jtag_axi_0/aclk]
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins cci_master_0/clk_i] 
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins axi_interconnect_0/ACLK]
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins axi_interconnect_0/S00_ACLK]
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins axi_interconnect_0/M00_ACLK]
connect_bd_net [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins proc_sys_reset_2/slowest_sync_clk]
connect_bd_net [get_bd_pins proc_sys_reset_2/interconnect_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_2/interconnect_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_2/interconnect_aresetn] [get_bd_pins axi_interconnect_0/ARESETN]
connect_bd_net [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins jtag_axi_0/aresetn]
connect_bd_net [get_bd_pins proc_sys_reset_2/peripheral_reset] [get_bd_pins cci_master_0/rst_i]
...
connect_bd_net [get_bd_pins processing_system7_0/FCLK_RESET1_N] [get_bd_pins proc_sys_reset_2/ext_reset_in]
...
connect_bd_intf_net -boundary_type upper [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins cci_master_0/ctrl_if]
...
make_bd_pins_external [list                       \
  ...
  [get_bd_pins csi2_2_lane_rx_0/dphy_lp_clk_p_i]  \
  [get_bd_pins csi2_2_lane_rx_0/dphy_lp_clk_n_i]  \
  [get_bd_pins csi2_2_lane_rx_0/dphy_data_p_i]    \
  [get_bd_pins csi2_2_lane_rx_0/dphy_data_n_i]    \
  [get_bd_pins csi2_2_lane_rx_0/dphy_lp_data_p_i] \
  [get_bd_pins csi2_2_lane_rx_0/dphy_lp_data_n_i] \
  ...
  [get_bd_pins cci_master_0/cam_pwup_o]           \
  [get_bd_pins cci_master_0/scl_io]               \
  [get_bd_pins cci_master_0/sda_io]]

# Mapping CCI-Master
assign_bd_address [get_bd_addr_segs {cci_master_0/ctrl_if/reg0 }]
...
# Create HDL Wraper
make_wrapper -files [get_files ./zybo_z7_video_proc.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./zybo_z7_video_proc.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v
file copy -force ../misc/err_bit_pos_lut.txt ./zybo_z7_video_proc.srcs/sources_1/bd/design_1/
