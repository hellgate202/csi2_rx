...
set_false_path -from [get_pins {csi2_rx/phy/byte_align[*].settle_ignore/FSM_onehot_state_reg[4]/C}] -to [get_pins {csi2_rx/phy/hs_data_valid_d1_reg[*]/D}]
